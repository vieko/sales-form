...
export const intentAnalysis = tool({
  ...
  inputSchema: z.object({
    howCanWeHelpText: z.string().describe('The "how can we help" text from the form'),
    companyContext: z.string().describe('Additional company context for better analysis').optional(),
  }),
